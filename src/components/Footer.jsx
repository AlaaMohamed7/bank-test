    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
        <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
            <div className='flex-[1] flex flex-col justify-start mr-10'>
              <div className=' flex items-end font-poppins'>
                 <img src={logoImg} className='w-[72px] h-[72px]' />
                 <div className='flex space-x-0 text-[40px] font-semibold pl-1  '>
            ...
            <div className='flex-[1.5] w-full flex flex-row flex-wrap justify-between md:mt-0 mt-10'>
                {footerLinks.map((footerLink) => (
                    <div key={footerLink.title} className='flex flex-col ss:my-0 my-4 min-w-[150px]'>
                        <h4 className='font-poppins mb-3 font-medium text-[18px] leading-[27px] text-white'>
                           {footerLink.title} 
                        </h4>
